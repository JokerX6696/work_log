...
library(ggplot2)
library(reshape2)
df <- read.table('stat_group.txt',sep = '\t',header = TRUE)
...
ggsave(filename = 'All_sample_group.png',device = 'png',width = 8, height = 6)
ggsave(filename = 'All_sample_group.pdf',device = 'pdf',width = 8, height = 6)
