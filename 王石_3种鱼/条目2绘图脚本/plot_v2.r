...
library(ggplot2)
library(reshape2)
df <- read.table('stat2species.txt',sep = '\t',header = TRUE)
...
ggsave(filename = 'All_sample_2.png',device = 'png',width = 8, height = 6)
ggsave(filename = 'All_sample_2.pdf',device = 'pdf',width = 8, height = 6)
